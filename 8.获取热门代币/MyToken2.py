...
class GetMyToken:
    ...
    def __init__(self,no) -> None:
        ...
        self.driver = webdriver.Chrome(service=Service("D://vscodefile/8.获取热门代币/chromedriver.exe"),options=chrome_options)
...
def main():
    ...
    #只保留有合约或官网信息的代币
    df.to_csv(f'D:/vscodefile/8.获取热门代币/save/Mytoken{date_}更新.csv',index=False)
